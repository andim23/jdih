<div class="row">
    <div class="col-md-12">
        <form id="form" action="<?= base_url() ?>Update_update_permohonan/simpan_json" method="POST" class="form-horizontal">
        ...
        <div class="form-group">
            ...
            <div class="col-md-9">
                <a href="<?= base_url() ?>upload/berkas_update_permohonan/<?= $row->berkas_nota_dinas ?>" target="_blank" class="red">
        ...
        <div class="form-group">
            <label class="control-label col-md-3">&nbsp;</label>
            <div class="col-md-9">
                <a href="<?= base_url() ?>upload/berkas_update_permohonan/<?= $row->berkas_position_paper ?>" target="_blank" class="red">
        ...
        <div class="form-group">
            <label class="control-label col-md-3">&nbsp;</label>
            <div class="col-md-9">
                <a href="<?= base_url() ?>upload/berkas_update_permohonan/<?= $row->berkas_draft_rancangan ?>" target="_blank" class="red">
        ...
        <div class="form-group">
            <label class="control-label col-md-3">&nbsp;</label>
            <div class="col-md-9">
                <a href="<?= base_url() ?>upload/berkas_update_permohonan/<?= $row->berkas_tahap_pembahasan ?>" target="_blank" class="red">
