...
<script>
    ...
    grid.init({
        ...
        dataTable: {// here you can define a typical datatable settings from http://datatables.net/usage/options 
            ...
            "ajax": {
                "url": "<?= base_url() ?>Permohonan_status/admin_ajax_list", // ajax source,
            },
            "aaSorting": [],
            "columnDefs": [{
                    "targets": -1,
            ...
            "fnRowCallback": function (nRow, aData, iDisplayIndex, iDisplayIndexFull) {
                ...
                $('td:eq(0),td:eq(2)', nRow).attr("align", "right");
    ...
    $('#datatable tbody').on('click', '.detail', function (e) {
        ...
        $.ajax({
            cache: false,
            type: "get",
            url: "<?= base_url() ?>Permohonan_status/get_data_by_id_json",
            data: "id=" + id,
    ...
    $('#datatable tbody').on('click', '.delete', function (e) {
        ...
        if (confirm('Anda yakin menghapus data ini ?')) {
            $.ajax({
                cache: false,
                type: "get",
                url: "<?= base_url() ?>Permohonan_status/hapus_json",
                data: "id=" + id,
                success: function (response) {
                    var data = JSON.parse(response);
