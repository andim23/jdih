...
/**
 * Description of Permohonan_status_m
 *
 * @author Selamet Subu - Dell 5459
 */
class Permohonan_status_m extends My_model {

    //put your code here
    var $table = "permohonan_status";
    var $view = "permohonan_status";
    var $primary_key = "id_permohonan_status";
